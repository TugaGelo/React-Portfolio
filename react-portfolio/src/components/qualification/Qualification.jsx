        ...
        <div className="qualification__sections">
          ...
          >
            <div className="qualification__data">
              <div>
                <h3 className="qualification__title">Junior/Senior Highschool</h3>
            ...
            <div className="qualification__data">
              ...
              <div>
                <h3 className="qualification__title">BS in Information Technology</h3>
                <span className="qualification__subtitle">
                  PUP - Sta. Mesa
                  </span>
                <div className="qualification__calendar">
          ...
          >
            <div className="qualification__data">
              <div>
                <h3 className="qualification__title">Service Crew</h3>
                <span className="qualification__subtitle">
