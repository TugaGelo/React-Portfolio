...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Tugaoen, Roland Angelo B.
            <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
        ...
        <p className="home__description">I'm a driven web developer focused on crafting innovative and efficient digital solutions.</p>

        <a href="https://www.facebook.com/rolandtugaoen2016/" className="button button--flex">
        Say Hello  
        <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
